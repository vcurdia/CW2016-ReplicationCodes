function [x,rc] = csolvevb(FUN,x,gradfun,crit,itmax,fid,verbose,varargin)

% csolvevb
%
% based on csolve, but added options for display manipulation
%
% Options added:
%   fid
...
%   verbose (logical)
%     If set to 1 the displays certain messages. Default: 0.
%   realsmall
...
% ...........................................................................
% 
% Created: February 3, 2016 by Vasco Curdia
% 
% Copyright 2016 by Vasco Curdia

%% -------------------------------------------------------------------

if ~exist('fid','var') || isempty(fid), fid = 1; end
...
while ~done
   if itct>3 & af00-af0<crit*max(1,af0) & rem(itct,2)==1
      ...
      if isreal(grad)
         ...
         if verbose
             fprintf(fid,'gradient imaginary');
         end
         randomize=1;
      end
   end
